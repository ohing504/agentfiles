...
function SidebarGroupLabel({
  ...
  return (
    <Comp
      ...
      // Fix: pointer-events-none added for collapsed icon mode.
      // Without it, the invisible label (-mt-8 + opacity-0) overlaps the last menu item
      // of the previous group and blocks its click events. (shadcn sidebar bug)
      className={cn(
