...
### v1 — 로컬 설정 관리 GUI (VS Code Extension)

**목표:** 오영님이 매일 쓰는 Claude 설정 관리 불편함 해결
...
1. 설정 파일 트리 뷰
   ...
   - 글로벌 vs 프로젝트 스코프 색상 구분
   - 동일 이름 agent/command 충돌 감지 및 경고
...
1. GitHub repo 생성 (`agentfiles`)
2. VS Code Extension 보일러플레이트 세팅
3. `~/.claude/` 파일 트리 읽기 구현
4. 사이드바 패널 UI 구현
5. CLAUDE.md 편집 연결
